...
func defeat() -> void:
	...
	if randf() <= 0.2:
		if player_battle_health and player_battle_health.has_method("heal"):
			player_battle_health.heal(1)
			print("El jugador recuperó 1 punto de vida")
