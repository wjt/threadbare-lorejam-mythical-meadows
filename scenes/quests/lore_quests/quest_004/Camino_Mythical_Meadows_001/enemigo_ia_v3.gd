...
func damage_feedback() -> void:
	...
	damage_tween.tween_property(sprite, "position", sprite_original_position + Vector2(6, 0), 0.04)
	damage_tween.tween_property(sprite, "position", sprite_original_position + Vector2(-6, 0), 0.04)
	damage_tween.tween_property(sprite, "position", sprite_original_position + Vector2(4, 0), 0.04)
	damage_tween.tween_property(sprite, "position", sprite_original_position, 0.04)

	damage_tween.parallel().tween_property(sprite, "modulate", Color(1, 1, 1), 0.16)
